...
_merge:
	...
	mov qword [g_2], rcx
	mov rsi, rdx
	mov rdi, qword [rdi + rbx * 8 + 8]
	call _merge
	mov rcx, qword [g_2]
	mov rdi, qword [g_1]
	mov rsi, qword [g_0]
	mov qword [rdi + rbx * 8 + 8], rax
	mov rax, qword [rcx + rbx * 8 + 8]
	mov rdx, qword [rdi + rbx * 8 + 8]
	mov qword [rcx + rbx * 8 + 8], rdx
	mov qword [rdi + rbx * 8 + 8], rax
	mov rax, rbx
	jmp b7
	b3:
