...
_main:
	...
	jg b14
	b15:
	cmp qword [rbx + r14 * 8 + 8], 0
	jne b16
	jmp b17
	b16:
	inc r15
	mov rax, qword [rbp - 8]
	mov qword [rax + r15 * 8 + 8], r14
	mov rax, r14
	sub rax, 1
	...
	b23:
	b24:
	mov qword [rbx + rsi * 8 + 8], 0
	b25:
	mov rax, rcx
	cdq
	mov r8, qword [rbp - 8]
	idiv qword [r8 + rdi * 8 + 8]
	mov rax, rdx
	cmp rax, 0
	je b26
	b27:
